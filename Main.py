...
from PySide.QtGui import QApplication, QStandardItemModel, QStandardItem, QTableView, QPen, QColor, QSlider, QFormLayout, QListView, QScrollArea
...
# test = Marb.Graph()
# testModel = Marb.GraphModel( 2, 1 )
# for i in range( testModel.rowCount() ):
# 	testModel.setData( testModel.index( i, 0 ), i )

# testModel.addEdge( 0, 0, 1, 0 )
