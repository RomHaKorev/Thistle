...
public:
    ...
    {
        return d_ptr->xLabelsLength;
    };
    qreal yLabelsLength() const
    {
        return d_ptr->yLabelsLength;
    };
    ...
    int nbDigits() const
    {
        return d_ptr->nbDigits;
    };
    int nbTicks() const
    {
        return d_ptr->nbTicks;
    };
    ...
    {
        d_ptr->xLabelsLength = l;
    };
    void setYLabelsLength( int l )
    {
        d_ptr->yLabelsLength = l;
    };
