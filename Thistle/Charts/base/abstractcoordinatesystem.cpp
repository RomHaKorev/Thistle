...
unsigned int AbstractCoordinateSystem::precision( unsigned int axisIndex ) const
{
	return d_ptr->axis( axisIndex ).precision();
}


void AbstractCoordinateSystem::setPrecision( unsigned int axisIndex, unsigned int precision )
{
...
qreal AbstractCoordinateSystem::axisLength( unsigned int axisIndex ) const
{
