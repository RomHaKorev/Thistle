...
public:
    ...
    */
    static QColor predefinedColor( int key ) {
        QMetaObject metaObject = Global::staticMetaObject;
...
Q_DECLARE_OPERATORS_FOR_FLAGS( Global::Types )

typedef Global::Shape Shape;
typedef Global::Types Types;
typedef Global::PredefinedColor Color;
