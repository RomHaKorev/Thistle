...
#include "Thistle/kernel/global.h"
...
int main( int argc, char* argv[] ) {
    ...
    style.setType( Thistle::Spline /*| Thistle::Thistle::Dot | Thistle::Thistle::Area*/ );
    linear.setSerieFormat( 1, style );
    style = linear.serieFormat( 0 );
    style.setType( Thistle::Line | Thistle::Area );
    style.setShape( Thistle::Triangle );
    ...
    /*Thistle::LinearChart* radial = new Thistle::LinearChart();
    radial->setModel( model2 );
    radial->show();*/
